...
MIDDLEWARE = [
    ...
    'core.middleware.JWTAuthenticationMiddleware',  # Move to END
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.JWTAuthentication',  # Our custom JWT auth
    ],
...
# JWT Settings (will use later for authentication)
